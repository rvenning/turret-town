// Shared across all the family games — each one gets its own Firestore
// collection inside the same project. This is a client config, not a secret:
// the key is restricted to the Cloud Firestore API.
